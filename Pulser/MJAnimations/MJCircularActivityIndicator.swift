//
//  MJCircularActivityIndicator.swift
//  Pulser
//
//  Created by maroleanj on 12/09/23.
//

import UIKit

class MJAnimateProgressView: UIView {
    ...
    //MARK: - Public methods
    public func show() {
        self.setupMJAnimateProgressView()
    ...
    private func setupMJAnimateProgressView() {
        ...
        innerLoaderView.layer.cornerRadius = widthProgressView/2
        ...
        let innercenter = CGPoint (x: innerLoaderView.frame.size.width / 2, y: innerLoaderView.frame.size.height / 2)
        let circlePath = UIBezierPath(arcCenter: innercenter, radius: CGFloat(radius), startAngle: .pi, endAngle: .pi*4, clockwise: true)
        ...
        innerLoaderView.layer.addSublayer(CircleLayer)
